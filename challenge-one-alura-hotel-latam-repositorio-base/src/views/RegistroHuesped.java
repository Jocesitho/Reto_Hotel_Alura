...
public class RegistroHuesped extends JFrame {
	...
	private HuespedesControlador husepeControl;
	private ReservaControlador reserControl;
	...
	public RegistroHuesped(int idReserva) {
		...
		this.husepeControl=new HuespedesControlador();
		this.reserControl= new ReservaControlador();
	...
	private void guardarHuespedes() {
		if(txtFechaN.getDate()!=null && !txtNombre.equals("")&& !txtApellido.equals("") && !txtTelefono.equals("")) {
			...
			this.husepeControl.guardar(huespedes);
